...
class querybuilder
{
    ...
    protected static function groupByStatement($groupByTableAbbreviation, $groupByColumn, $groupByOrder = null)
    {
        ...
        $group .= $groupByTableAbbreviation;
        $group .= ".";
        $group .= $groupByColumn;
    ...
    {
        $selectColumn = '';
        $selectColumn .= $tableAbbreviation . ".";
        $selectColumn .= $column;
        if($as){
            $selectColumn .= " AS ";
            $selectColumn .= $value;
    ...
    protected static function joinColumnArrayQuery($columnArray, $joinTableAbbreviation, $currentParentKey, $lastParentKey)
    {
        $j = 0;
        $joinColumns = "";
        if(is_array($columnArray)) {
